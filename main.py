...
def applyRandRot(x,y):
    ...
    for pair in zip(x,y):
        ...
        out_x.append(imutils.rotate(pair[0],this_theta))
...
for ii in range(100):
    ...
    train_gen = Mygenerator(this_trainList,this_trainList,batch_size)
    ...
    model.save('models_both/{ii}'.format(ii=ii))
